    ...
    return (
        <div className="review_container">
            <div className="review_customer1">
                <img src={customer1} width="250px" height="250px" alt="customer"/>
                <img src={speachmarks} width="70px" alt="speech marks"/>
                <p>Thank you so much for coming out so quickly. Brilliant service!</p>
            </div>
            <div className="review_customer2">
                <img src={customer2} width="250px" height="250px" alt="customer"/>
                <img src={speachmarks} width="70px" alt="speech marks"/>
                <p>Can't believe how good the service was. Absolutely amazing!!!</p>
            </div>
            <div className="review_customer3">
                <img src={customer3} width="250px" height="250px" alt="customer"/>
                <img src={speachmarks} width="70px" alt="speech marks"/>
